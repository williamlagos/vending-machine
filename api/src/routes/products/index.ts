...
import { createProduct, updateProduct, removeProduct, getProductById, getProducts, buyProducts } from './controllers'
...
router.post('/:productId/buy', passport.authenticate('jwt', { session: false }), elevateBuyerRole as RequestHandler, buyProducts as RequestHandler)
