...
import { createUser, updateUser, removeUser, getUserById, getUsers, depositCoins, resetCoins } from './controllers'
...
router.get('/:userId', passport.authenticate('jwt', { session: false }), getUserById as RequestHandler)
